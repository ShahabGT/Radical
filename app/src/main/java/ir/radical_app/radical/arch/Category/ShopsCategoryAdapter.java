...
public class ShopsCategoryAdapter extends PagedListAdapter<ShopsCategoryItem, ShopsCategoryAdapter.ItemViewHolder> {

    private Context mCtx;
    private FragmentActivity activity;

    public ShopsCategoryAdapter(Context mCtx, FragmentActivity activity) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, int position) {
        ...
        final ShopsCategoryItem item = getItem(position);
...
//                    fm.popBackStackImmediate();
    ...
    private static DiffUtil.ItemCallback<ShopsCategoryItem> DIFF_CALLBACK =
            new DiffUtil.ItemCallback<ShopsCategoryItem>() {
                @Override
                public boolean areItemsTheSame(ShopsCategoryItem oldItem, ShopsCategoryItem newItem) {
