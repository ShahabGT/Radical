...
public class BookmarkAdapter extends PagedListAdapter<BookmarkItem, BookmarkAdapter.ItemViewHolder> {

    private Context mCtx;
    private FragmentActivity activity;

    public BookmarkAdapter(Context mCtx, FragmentActivity activity) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, int position) {
        ...
        final BookmarkItem item = getItem(position);
    ...
    private static DiffUtil.ItemCallback<BookmarkItem> DIFF_CALLBACK =
            new DiffUtil.ItemCallback<BookmarkItem>() {
                @Override
                public boolean areItemsTheSame(BookmarkItem oldItem, BookmarkItem newItem) {
